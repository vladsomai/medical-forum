<script lang="ts">
	...
	import DatetimeIcon from '$lib/images/icons/appointment-datetime.svg';
...
<div class="mt-[15vh] mx-[10%] flex flex-col justify-center items-center">
	<p class="text-justify my-5">
		In cazul in care doresti sa iti faci o programare fara un cont, completeaza formularul de mai
		jos iar noi vom reveni catre tine cu un apel telefonic pentru a confirma programarea.
	</p>
	<form class="flex flex-col w-[80%]" on:submit={handleAppointment}>
		...
		<div class="input input-primary mb-4 rounded-full flex justify-between items-center ">
			<img src={DatetimeIcon} alt="appointment date" />
			<input
				name="date"
				required
				placeholder="Data"
		...
		<button
			...
			disabled={loading}
			type="submit">Programeaza-te fara un cont!</button
		>
	</form>
</div>
